...
function Navbar() {
  return (
    <nav>
      <div className="w-full flex justify-evenly items-center border-b-2 border-b-pink-600">
        <div>
        ...
        <div>
          <nav>
            ...
            <Link href="/login" className="px-5 py-2 rounded-md text-white0" >login</Link>
              <Link href="/signup" className="px-5 py-2 rounded-md text-white bg-pink-600" >Register</Link>
